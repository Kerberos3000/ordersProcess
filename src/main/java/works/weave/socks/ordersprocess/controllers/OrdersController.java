...
import works.weave.socks.ordersprocess.config.OrdersConfigurationProperties;
...
import works.weave.socks.ordersprocess.repositories.CustomerOrderRepository;
...
public class OrdersController {
	...
	public @ResponseBody CustomerOrder newOrder(@RequestBody NewOrderResource item) {
		...
		try {
			...
			// "items":"http://api/carts/carts/57a98d98e4b00679b4a830b2/items"}
